...
// // Keep original name, encode for URL (spaces → %20, browser standard)
...
//       {/* Info — clean name + date strip matching screenshot style */}
//       <div className="c-info">
//         <h3 className="c-name">{event.name}</h3>
//         <span className="c-apr">APR, 2025</span>
//       </div>
...
//       <div style={{height:115,background:"rgba(2,0,14,.9)",border:"1px solid rgba(0,255,240,.12)",borderTop:"none"}}/>
...
//             <p className="h-eye">NIT JAMSHEDPUR // CSE</p>
//             <h1 className="h-title">
//               <span className="ht-c">EVENTS</span><br/>
//               <span className="ht-m">ARCHIVE</span>
//             </h1>
//             <p className="h-sub">Encrypted event frames from XAVENIR &amp; SCSE ops.<br/>Hover to decrypt details. Click to open a node.</p>
//             <p className="h-fn">// events.archive()</p>
//           </div>

//           <div className="hero-r">
//             <div className="ops">
//               <p className="ops-ttl">OPS.CONSOLE</p>
...
//                 <div><span className="sn c">{count || "—"}</span><span className="sl">ACTIVE NODES</span></div>
//                 <div><span className="sn m">{count || "—"}</span><span className="sl">EVENT FRAMES</span></div>
//               </div>
//             </div>
//             <div className="scse-b">
//               <span className="sb-rdy">EVENTS // READY</span>
//               <div className="sb-row"><span className="sb-s">SCSE</span><span className="sb-a">ARCHIVE</span></div>
//               <div className="sb-row sub"><span className="sb-sub">CYBER WORLD</span><span className="sb-sub">SELECTION</span></div>
//             </div>
//           </div>
//         </section>
...
//           <div className="gh">
//             <span className="ghl"/><span className="gh-lbl">// ACTIVE.EVENT.NODES</span><span className="ghl r"/>
//           </div>
//           <div className="egrid">
//             {loading
...
//         .bg-city{position:fixed;inset:0;background:url('https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=1600&q=60') center/cover;opacity:.1;pointer-events:none;z-index:0}
//         .bg-overlay{position:fixed;inset:0;background:linear-gradient(180deg,rgba(6,8,24,.75) 0%,rgba(6,8,24,.55) 40%,rgba(6,8,24,.88) 100%);pointer-events:none;z-index:0}
//         .bg-grid{position:fixed;inset:0;background-image:linear-gradient(rgba(0,255,240,.04) 1px,transparent 1px),linear-gradient(90deg,rgba(0,255,240,.04) 1px,transparent 1px);background-size:55px 55px;pointer-events:none;z-index:0}
//         .bg-glow{position:fixed;border-radius:50%;pointer-events:none;z-index:0;filter:blur(140px)}
//         .bg-glow.c{width:600px;height:600px;top:-120px;left:-200px;background:#00fff0;opacity:.07}
//         .bg-glow.m{width:700px;height:700px;bottom:-200px;right:-200px;background:#ff2d78;opacity:.07}

//         /* Hero */
//         .hero{position:relative;z-index:1;display:flex;justify-content:space-between;align-items:center;padding:52px 6vw 44px;gap:36px;flex-wrap:wrap}
//         .hero-l{flex:1;min-width:280px}
//         .h-eye{font-size:.7rem;letter-spacing:.25em;color:rgba(0,255,240,.5);margin-bottom:16px}
//         .h-eye::before{content:'— ';color:#ff2d78}
//         .h-title{font-family:'Orbitron',sans-serif;font-size:clamp(3rem,7.5vw,6.5rem);font-weight:900;line-height:.95;margin-bottom:20px}
//         .ht-c{color:#00fff0;text-shadow:0 0 28px rgba(0,255,240,.5),0 0 55px rgba(0,255,240,.18)}
//         .ht-m{color:#ff2d78;text-shadow:0 0 28px rgba(255,45,120,.5),0 0 55px rgba(255,45,120,.18)}
//         .h-sub{font-size:.8rem;color:rgba(200,220,255,.5);line-height:1.65;max-width:400px;margin-bottom:18px}
//         .h-fn{color:rgba(0,255,240,.32);font-size:.78rem;letter-spacing:.1em}
//         .hero-r{display:flex;flex-direction:column;gap:18px;align-items:flex-end;flex-shrink:0;align-self:center}

//         /* Ops */
//         .ops{background:rgba(0,8,26,.88);border:1px solid rgba(0,255,240,.2);padding:16px 20px;min-width:248px}
//         .ops-ttl{font-size:.6rem;letter-spacing:.2em;color:rgba(0,255,240,.38);margin-bottom:10px}
//         .ops-l{font-size:.76rem;color:rgba(200,220,255,.55);margin-bottom:5px}
//         .ok{color:#00fff0}
//         .ops-div{height:1px;background:rgba(0,255,240,.15);margin:12px 0}
...
//         .sl{font-size:.57rem;letter-spacing:.15em;color:rgba(200,220,255,.35);display:block;margin-top:3px}

//         /* SCSE badge */
//         .scse-b{border:2px solid #00fff0;padding:13px 18px;min-width:248px;box-shadow:0 0 20px rgba(0,255,240,.12),inset 0 0 20px rgba(0,255,240,.03)}
//         .sb-rdy{font-size:.58rem;letter-spacing:.18em;color:rgba(0,255,240,.45);display:block;margin-bottom:7px}
//         .sb-row{display:flex;justify-content:space-between;align-items:baseline}
//         .sb-s{font-family:'Orbitron',sans-serif;font-size:1.7rem;font-weight:900;color:#00fff0;text-shadow:0 0 18px rgba(0,255,240,.55)}
//         .sb-a{font-family:'Orbitron',sans-serif;font-size:1.7rem;font-weight:900;color:#ff2d78;text-shadow:0 0 18px rgba(255,45,120,.55)}
//         .sb-row.sub{margin-top:4px}
//         .sb-sub{font-size:.58rem;letter-spacing:.14em;color:rgba(200,220,255,.35)}

//         /* Grid section */
//         .gsec{position:relative;z-index:1;padding:0 6vw 80px}
//         .gh{display:flex;align-items:center;gap:14px;margin-bottom:26px}
//         .ghl{flex:1;height:1px;background:linear-gradient(90deg,transparent,rgba(0,255,240,.3))}
//         .ghl.r{background:linear-gradient(90deg,rgba(0,255,240,.3),transparent)}
//         .gh-lbl{font-size:.66rem;letter-spacing:.2em;color:rgba(0,255,240,.45);white-space:nowrap}
