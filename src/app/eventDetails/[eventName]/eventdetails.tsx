...
//         .ib-title { font-family:'Orbitron',sans-serif; font-size:.72rem; font-weight:700;
...
//         }
//         .header-desc {
//           font-size: .82rem; color: rgba(200,220,255,.55);
...
//         }
//         .hb-rdy { font-size:.57rem; letter-spacing:.18em; color:rgba(0,255,240,.45); display:block; margin-bottom:7px; }
//         .hb-row { display:flex; justify-content:space-between; align-items:baseline; }
//         .hb-scse { font-family:'Orbitron',sans-serif; font-size:1.6rem; font-weight:900; color:#00fff0; text-shadow:0 0 16px rgba(0,255,240,.55); }
//         .hb-date { font-family:'Orbitron',sans-serif; font-size:1.6rem; font-weight:900; color:#ff2d78; text-shadow:0 0 16px rgba(255,45,120,.55); }
//         .hb-sub-row { display:flex; justify-content:space-between; margin-top:4px; }
//         .hb-sub { font-size:.57rem; letter-spacing:.13em; color:rgba(200,220,255,.35); }
...
//           font-family:'Share Tech Mono',monospace; font-size:.6rem;
//         }
//         .isb-dec { color:#00fff0; min-width:72px; }
...
//         .isb-clr { color:#ff2d78; font-size:.57rem; }
...
//         }
//         .tv-label { font-size:.6rem; letter-spacing:.2em; color:rgba(0,255,240,.4); }
...
//         .tv-range { font-size:.75rem; color:rgba(200,220,255,.5); }
...
//         .pay-desc { font-size:.78rem; color:rgba(200,220,255,.65); line-height:1.55; }
//         .pay-highlight { color:#00fff0; font-weight:700; }
//         .pay-checks { display:flex; flex-direction:column; gap:4px; margin-top:8px; }
//         .pay-check { font-size:.72rem; color:rgba(0,255,128,.75); }
//         .pay-list {
//           list-style:none; display:flex; flex-direction:column; gap:4px;
//           margin-top:6px;
//         }
//         .pay-list li { font-size:.75rem; color:rgba(255,150,150,.75); }
...
//       <p style={{fontFamily:"'Share Tech Mono',monospace",fontSize:".57rem",letterSpacing:".18em",
//         color:"rgba(200,220,255,.38)",marginBottom:5}}>{label}</p>
//       <p style={{fontFamily:"'Orbitron',sans-serif",fontSize:"1.25rem",fontWeight:700,color:c.val,lineHeight:1}}>{value}</p>
//     </div>
//   );
// }
