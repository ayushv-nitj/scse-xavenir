...
const PROFESSORS: Professor[] = [
  { name: "Dr. Dilip Kumar Shaw",  role: "Head of Department", img: "https://res.cloudinary.com/dtieuimsz/image/upload/v1775218079/dr_dilip_kumar_xdfvce.jpg" },
  ...
  return (
    <>
      <style>{`
        ...
        .prof-img-wrap { position: relative; width: 150px; height: 150px; }
        .prof-img-border {
        ...
        <section className="about-section">
          ...
          <div ref={aboutRef} className={`about-grid ${aboutIn ? "in-view" : ""}`}>
            ...
            <div className="about-xavenir-block">
              ...
              <a href="/brochure.pdf" target="_blank" rel="noopener noreferrer" className="xav-btn">
                ▶ View Brochure
              </a>
            </div>
          </div>
