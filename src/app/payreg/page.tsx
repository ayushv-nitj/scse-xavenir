...
const s: Record<string, React.CSSProperties> = {
  ...
  qrSection: { display: "flex", flexDirection: "column" as const, gap: "1rem", alignItems: "center", width: "100%" },
  qrWrap: { padding: "0.8rem", width: "100%", maxWidth: 280, display: "flex", justifyContent: "center", background: "rgba(0,245,255,0.04)", borderWidth: 1, borderStyle: "solid", borderColor: "rgba(0,245,255,0.15)", clipPath: "polygon(0 0,calc(100% - 10px) 0,100% 10px,100% 100%,10px 100%,0 calc(100% - 10px))" },
  qrImg: { width: "100%", height: "auto", display: "block", aspectRatio: "1 / 1", filter: "brightness(0.95) contrast(1.1)" },
  amountWrap: { display: "flex",alignItems: "center", textAlign: "center",flexDirection: "column" as const, gap: "0.5rem" },
